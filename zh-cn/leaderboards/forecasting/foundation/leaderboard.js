...
const LeaderboardApp = {
  ...
  config: {
    ...
    MODELS_LIST: ["AutoTimes","CALF","Chronos","Dlinear","FedFormer","FITS","GPT4TS","LLMMixer","MOIRAI","Moment","PatchTST","ROSE","S2IPLLM","TimeLLM","TimeMixer",'TimesFM',"TimesNet","TTMs","UniTS","UniTime","iTransformer","Timer","LightGTS","Sundial","Toto2"],
