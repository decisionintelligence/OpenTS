...
const LeaderboardApp = {
  ...
  config: {
    API_URL: 'https://120.77.11.87:3333/outlier/uni/rank',
    MODELS_INFO: { 
      },
  ...
  _renderEmptyTable() {
    const modelKeys =[...this.config.MODEL_TYPES_LIST['Deep-Learning'], ...this.config.MODEL_TYPES_LIST['Machine-Learning'], ...this.config.MODEL_TYPES_LIST['Non-Learning']] ;
