...
const LeaderboardApp = {
  ...
  config: {
    ...
    MODELS_INFO: { 
      ...
      "TTM": {"paper-url": "https://arxiv.org/pdf/2401.03955", "publication": "NIPS", "bib": "https://dblp.uni-trier.de/rec/conf/nips/EkambaramJ0MNGR24.html?view=bibtex", "year": "2024", "parameters": "805287"}, 
      ...
      "Toto2":{"paper-url": "https://www.datadoghq.com/blog/ai/toto-2/", "publication": "arXiv", "bib": "", "year": "2026", "parameters": "312680000"},
    },
    MODEL_TYPES_LIST:{"TS Pretrain":["Chronos","MOIRAI","Moment","ROSE",'TimesFM',"Timer","TTM","UniTS","LightGTS","Sundial","Toto2"],"LLM Based":["AutoTimes","CALF","GPT4TS","LLMMixer","S2IPLLM","TimeLLM","UniTime"], "Specific":["PatchTST","Dlinear","FedFormer","FITS","TimeMixer","TimesNet","iTransformer"]},
    MODELS_LIST: ["AutoTimes","CALF","Chronos","Dlinear","FedFormer","FITS","GPT4TS","LLMMixer","MOIRAI","Moment","PatchTST","ROSE","S2IPLLM","TimeLLM","TimeMixer",'TimesFM',"TimesNet","TTM","UniTS","UniTime","iTransformer","Timer","LightGTS","Sundial","Toto2"],
