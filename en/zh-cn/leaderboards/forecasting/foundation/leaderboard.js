...
const LeaderboardApp = {
  ...
  config: {
    ...
    MODELS_INFO: { 
      ...
      "Sundial(128m)":{"paper-url": "", "publication": "", "bib": "", "year": "2025", "parameters": "128000000"},
      "Toto2.0(313m)":{"paper-url": "", "publication": "", "bib": "", "year": "2025", "parameters": "313000000"},
    },
    MODEL_TYPES_LIST:{"TS Pretrain":["Chronos","MOIRAI","Moment","ROSE",'TimesFM',"Timer","TTMs","UniTS","LightGTS","Sundial(128m)","Toto2.0(313m)"],"LLM Based":["AutoTimes","CALF","GPT4TS","LLMMixer","S2IPLLM","TimeLLM","UniTime"], "Specific":["PatchTST","Dlinear","FedFormer","FITS","TimeMixer","TimesNet","iTransformer"]},
    MODELS_LIST: ["AutoTimes","CALF","Chronos","Dlinear","FedFormer","FITS","GPT4TS","LLMMixer","MOIRAI","Moment","PatchTST","ROSE","S2IPLLM","TimeLLM","TimeMixer",'TimesFM',"TimesNet","TTMs","UniTS","UniTime","iTransformer","Timer","LightGTS","Sundial(128m)","Toto2.0(313m)"],
