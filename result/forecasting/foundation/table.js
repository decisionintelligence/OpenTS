...
const LeaderboardApp = {
  // --- 1. CONFIGURATION & CONSTANTS (内容不变) ---
    config: {
        ...
        MODEL_TYPES_LIST: {"TS-Pretrain":["Chronos","MOIRAI","Moment","ROSE",'TimesFM',"Timer","TTM","UniTS","LightGTS","Sundial","Toto2"], "LLM-Based":["CALF","GPT4TS","LLMMixer","S2IPLLM","TimeLLM","UniTime"], "Specific":["PatchTST","Dlinear","FedFormer","FITS","TimeMixer","TimesNet","iTransformer"]},
